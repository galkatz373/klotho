...
Landed baseline: AAA-01–27. KAI PRs are new and **none are landed** when this
document is written. Each header gains `— landed` only with its implementation,
tests, date bump, and this section's landed list update.
...
#### KAI-00 — Benchmark, hardware, model, and farm contract
...
#### KAI-03 — Authoring transactions and three-way semantic merge
...
#### KAI-04 — Structured diagnostics and counterexamples
...
#### KAI-06 — Journeys and trusted evidence
...
#### KAI-07 — Built-in Klotho AI subsystem and model fabric
...
#### KAI-08 — Distaff conversational plan/diff/evidence UX
...
#### KAI-10 — Action feel, camera, input, and haptics tuning
...
#### KAI-17 — Production presentation: geometry, VFX, lighting, faces, and audio
...
#### KAI-18 — Multimodal quality evaluation and review scaling
...
#### KAI-20 — Tapestry multi-Place vertical route
