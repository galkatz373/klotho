...
| Author | Gal Katz |
| Date | 2026-09-14 |
| Status | Current (rev 7 — PHYS-A01–A02 landed) |
| Last verified | 2026-09-14 through PHYS-A02 |
...
#### PHYS-A03–A12 — geometry through release acceptance — **planned**

- **Next:** PHYS-A03 lands shared geometry, oriented boxes, spheres, capsules, casts, and strengthened witness validation.
- **Then:** production contacts, terrain/constraints, character drive, semantic tracks, motion-contact admission, vehicles, breakable structures, Anvil diagnostics, and release acceptance follow in the order frozen by the plan.
