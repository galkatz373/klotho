...
| Author | Gal Katz |
| Date | 2026-09-14 |
| Status | Current (rev 7 — PHYS-A01–A03 landed) |
| Last verified | 2026-09-14 through PHYS-A03 |
...
- **Depends on:** PHYS-A02
- **Changes:** Adds `klotho-geom` (core-only) with oriented box, sphere, and capsule queries, ray/shape casts, and quantized witness reproduction. Commit verifies PhysIsland motion and gameplay contacts against that geometry; Space/Motion keep translation-AABB swept so Hearth/Ash hashes stay put. Convex, compound, and static terrain kinds fail closed until PHYS-A04/A05.

#### PHYS-A04–A12 — production contacts through release acceptance — **planned**

- **Next:** PHYS-A04 lands convex/compound hulls, stable manifolds, friction, restitution, mass/inertia, angular response, and thin-wall goldens.
- **Then:** terrain/constraints, character drive, semantic tracks, motion-contact admission, vehicles, breakable structures, Anvil diagnostics, and release acceptance follow in the order frozen by the plan.
