...
check_gameplay_jobs examples/netlock-slice
...
check_no_dcc examples/netlock-slice
...
check_no_phys examples/netlock-slice
...
check_no_stream examples/netlock-slice
